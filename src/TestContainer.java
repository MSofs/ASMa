...
public class TestContainer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            a.startAgentInPlatform("Jogador2", "Jogador", new Object[]{new Position(14, 16), "EquipaB","ofensivo"});

           // a.startAgentInPlatform("Jogador1", "Jogador", new Object[]{new Position(35, 35), "EquipaA","ofensivo"});
           // a.startAgentInPlatform("Jogador2", "Jogador", new Object[]{new Position(34, 35), "EquipaB","ofensivo"});
           // a.startAgentInPlatform("Jogador3", "Jogador", new Object[]{new Position(35, 34), "EquipaB","ofensivo"});
